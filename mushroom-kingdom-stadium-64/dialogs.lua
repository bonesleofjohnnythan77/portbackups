smlua_text_utils_dialog_replace(DIALOG_000,1,6,30,200, ("Grab the medal to \
complete events!"))
...
smlua_text_utils_dialog_replace(DIALOG_004,1,3,95,200, ("Hey, Ive heard of you!\
Your Mario who keeps \
saving us from bowser! \
Well, you may be skilled,\
but your gonna need\
luck to beat me! \
Ha Ha Ha!"))
...
smlua_text_utils_dialog_replace(DIALOG_020,1,6,95,150, ("Congratulations!\
Im glad to here you made \
it into the stadium \
Mario! But guess what? I\
Made it in too! See you\
there! From Yoshi"))
...
smlua_text_utils_dialog_replace(DIALOG_033,1,6,30,200, ("You have reached the\
Mushroom Kingdom Stadium!\
Enter a pipe to choose\
an event. Complete it\
to win a medal.\
\
Good luck!"))
...
smlua_text_utils_dialog_replace(DIALOG_114,1,5,95,200, ("Erk Erk! You mean man \
Mario who hurt poor\
Bob - King! Beacause you,\
poor me had to fix self!\
And me make mistakes!\
You pay for it!\
GLLLARRGGGHHY!!!"))

smlua_text_utils_dialog_replace(DIALOG_115,1,5,95,200, ("Nooooooooos! Me not\
want have to fix self\
again! NOT AGAIN! \
\
WAAAAAAAAAAAAA!!!"))
...
smlua_text_utils_dialog_replace(DIALOG_141,1,5,150,200, ("Congratulations on your\
first medal!"))

smlua_text_utils_dialog_replace(DIALOG_142,1,5,150,200, ("Wow! You have now won\
3 medals! Well done!"))

smlua_text_utils_dialog_replace(DIALOG_143,1,6,150,200, ("Your becoming a fine \
competitor Mario! You\
now have 8 medals!"))

smlua_text_utils_dialog_replace(DIALOG_144,1,6,150,200, ("Amazing! You have \
actually collected \
every single medal! You\
are the ultimate champion\
Mario! The only thing\
left to do now is beat\
your old hi-scores!"))
...
smlua_text_utils_dialog_replace(DIALOG_167,1,4,30,200, ("Wellcome to the stadium!\
Enter a pipe to begin!\
We hope you win lots \
of medals!"))
