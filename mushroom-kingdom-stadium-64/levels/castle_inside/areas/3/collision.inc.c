const Collision castle_inside_area_3_collision_0x07073AAC[] = {
    COL_INIT(),
    ...
    COL_TRI_SPECIAL(78, 79, 80, 0x00C0),
    COL_TRI_SPECIAL(78, 81, 79, 0x00C0),
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(5),
    SPECIAL_OBJECT_WITH_YAW(special_haunted_door, -3097, -1279, 1434, 0),
    SPECIAL_OBJECT_WITH_YAW(special_haunted_door, -332, -767, 205, 0),
    SPECIAL_OBJECT_WITH_YAW(special_haunted_door, 717, -1177, -869, 192),
    SPECIAL_OBJECT_WITH_YAW(special_0stars_door, 1126, -1074, -2661, 192),
    SPECIAL_OBJECT_WITH_YAW_AND_PARAM(special_metal_door_warp, 7885, -1586, -511, 192, 0x0002),
