smlua_text_utils_course_acts_replace(COURSE_BOB, ("   EVENT PIPE 1"),	("RUN EVENT"),	("JUMP EVENT"),	("SHELL RIDE EVENT"),	("WALL KICK EVENT"),	("CANNON EVENT"),	("CHALLENGER - BOB-OMB KING"))
