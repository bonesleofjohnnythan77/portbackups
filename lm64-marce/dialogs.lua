smlua_text_utils_dialog_replace(DIALOG_000,1,6,30,200, ("Wow! Estas justo en el\
medio del espacio!\
ve y busca las estrellas de \
poder que bowser a escondido en \
todos lados.\
\
Buena suerte!!"))
...
smlua_text_utils_dialog_replace(DIALOG_004,1,3,95,200, ("Somos Bob-ombs amantes\
de la paz,\
por lo que no utilizamos\
disparadores.\
Pero si usted le gustara\
despegar, \
Vamos a preparar a todos\
los disparadores de este\
nivel paraque usted\
los utilice"))
...
smlua_text_utils_dialog_replace(DIALOG_008,1,5,30,200, ("Cuidado con el elevador.\
si te caes tendras que \
devolverte."))

smlua_text_utils_dialog_replace(DIALOG_009,1,5,30,200, (""))

smlua_text_utils_dialog_replace(DIALOG_010,1,4,30,200, ("Usted ha pisado el \
interruptor dela gorra \
voladora. \
su uso es para volar \
dandoun triple salto \
o despegando de un \
disparador.\
Ahora los bloques \
color rojo \
transparente \
seran solidos y \
encontraras la gorra \
voladora en cada bloque \
rojo.\
\
\
Quieres guardar?\
...
smlua_text_utils_dialog_replace(DIALOG_011,1,4,30,200, ("Usted ha pisado el \
interruptor de la gorra \
de metal. \
La gorra de metal hace que \
mario sea invencible y mas \
pesado.\
Ahora los bloques color \
verde transparente seran \
solidos y encontraras la \
gorra de metal en cada \
bloque verde.\
\
\
Quieres guardar?\
...
smlua_text_utils_dialog_replace(DIALOG_012,1,4,30,200, ("Usted ha pisado el \
interruptor dela gorra \
invisible. \
su uso es para traspasar \
ciertas paredes y \
algunos enemigos.\
Ahora los bloques color azul \
transparente seran solidos\
y encontraras la gorra \
invisible en cada bloque \
azul.\
\
\
Quieres guardar?\
...
smlua_text_utils_dialog_replace(DIALOG_013,1,5,30,200, ("has recogido 100 $! \
Luigi gana mas\
poder del castillo.\
\
Quieres guardar?\
...
smlua_text_utils_dialog_replace(DIALOG_014,1,4,30,200, ("Wow! Otra estrella de energia!\
Luigi gana ms valor\
del poder del castillo.\
Quieres guardar?\
\
//SI////No"))

smlua_text_utils_dialog_replace(DIALOG_015,1,4,30,200, ("Usted puede golpear a los \
enemigos para derribarlos. \
Presione [A] para saltar,\
[B] para golpear.\
Presione [A] y [B] para dar \
una patada.\
Para recoger algo,\
pulsar la tecla [B], tambien. \
Para lanzar\
algo que est sosteniendo,\
pulsar la tecla [B] de nuevo."))

smlua_text_utils_dialog_replace(DIALOG_016,1,3,30,200, ("Monta en el caparazon \
brillante y viaja a \
donde quieras! \
Derriba a tus \
enemigos!"))
...
smlua_text_utils_dialog_replace(DIALOG_018,1,4,30,200, ("Estoy durmiendo porque ...\
... estoy cansado.  No \
me gusta ser molestado.\
Por favor, camina en \
silencio."))

smlua_text_utils_dialog_replace(DIALOG_019,1,2,30,200, ("Shhh! Por favor, camine \
en silencio en el \
pasillo!"))

smlua_text_utils_dialog_replace(DIALOG_020,1,6,95,150, ("Querido Luigi:\
Por favor ven al\
castillo. Bowser se \
ha aliado con los boo\
y todo es horrible...\
..de verdad\
Princesa Peach"))
...
mejor vete y no vuelvas\
Bwa ja ja bwa!!"))

smlua_text_utils_dialog_replace(DIALOG_022,1,2,95,200, ("Necesitas una llave para \
abrir esta puerta"))

smlua_text_utils_dialog_replace(DIALOG_023,1,3,95,200, ("Esta llave no encaja!\
Tal vez sea por el\
sotano ..."))

smlua_text_utils_dialog_replace(DIALOG_024,1,5,95,200, ("Nesecitas una estrella de\
poder para abrir esta \
puerta\
"))

smlua_text_utils_dialog_replace(DIALOG_025,1,4,95,200, ("Se necesita el poder de\
3 Estrellas para abrir esta\
puerta. Es(son) necesaria(s)\
 [%] \
Estrellas mas."))

smlua_text_utils_dialog_replace(DIALOG_026,1,4,95,200, ("Se necesita el poder de\
8 Estrellas para abrir esta\
puerta. Es(son) necesaria(s) \
[%] \
Estrellas mas."))

smlua_text_utils_dialog_replace(DIALOG_027,1,4,95,200, ("Se necesita el poder de\
30 Estrellas para abrir esta\
puerta. Es(son) necesaria(s) \
[%] \
Estrellas mas."))

smlua_text_utils_dialog_replace(DIALOG_028,1,4,95,200, ("Se necesita el poder de\
...
smlua_text_utils_dialog_replace(DIALOG_030,1,6,30,200, ("Hola! soy Lakitu Bros.\
\
Te dire un consejo:\
\
Se puede tomar un\
mire a su alrededor con \
[C]> y [C]<. \
Pulse [C]| para ver la\
accion a distancia.\
Cuando no se puede mover el\
la camara mas lejos, el\
zumbador debe sonar.\
\
Adios."))
...
smlua_text_utils_dialog_replace(DIALOG_032,1,5,30,200, (""))

smlua_text_utils_dialog_replace(DIALOG_033,1,6,30,200, ("Presione [A] para saltar y \
[B] para atacar.\
Presione [B] para leer los \
letreros,\
tambien. Utilice la palanca \
de control\
en el centro del \
controlador\
para mover a Mario."))
...
smlua_text_utils_dialog_replace(DIALOG_036,1,5,30,200, (""))

smlua_text_utils_dialog_replace(DIALOG_037,1,2,30,200, (""))

smlua_text_utils_dialog_replace(DIALOG_038,1,3,95,200, ("En respuesta a la Estrella\
de poder, la puerta \
lentamente se abre."))

smlua_text_utils_dialog_replace(DIALOG_039,1,4,30,200, (""))

smlua_text_utils_dialog_replace(DIALOG_040,1,3,30,200, ("Atencin!\
Frio, frio\
A continuacin!"))
...
smlua_text_utils_dialog_replace(DIALOG_043,1,5,30,200, (""))
...
smlua_text_utils_dialog_replace(DIALOG_047,1,2,95,200, ("Hola! he preparado el \
...
smlua_text_utils_dialog_replace(DIALOG_051,1,6,30,200, ("Block enjoys 50 coins!!\
  \
   \
    \
\
...
smlua_text_utils_dialog_replace(DIALOG_140,1,6,30,200, ("Area del elevador \
\
Derecha:  Caverna de hielo\
////  Entrada\
Izquierda:Caida sin fin\
////  Elevador 1\
Flecha:   Estas aqui"))
...
smlua_text_utils_dialog_replace(DIALOG_161,1,4,30,200, ("Hola luigi!!\
\
bowser ha esparcido \
todas estrellas de poder\
\
entra al castillo,\
Adelante, luigi!"))
