...
MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_breakable_box_no_coins,     /*yaw*/  82, /*pos*/ -1366,   264,   4474, /*behParam*/ 0),
MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_hidden_1up_in_pole,         /*yaw*/   0, /*pos*/ -6270,   975, -2145,0),
MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_1up,                 /*yaw*/   0, /*pos*/  -440,  3180, -5000,0),
...
WARP_NODE(245,16,1,10,0),
OBJECT_WITH_ACTS(85,0,3174,-5625,0,0,0,0x0, bhvYoshi,31),
OBJECT_WITH_ACTS(207,-2397,501,-15,0,0,0,0x0, bhvFloorSwitchHiddenObjects,31),
OBJECT_WITH_ACTS(129,-2364,465,-426,0,0,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(129,-2168,905,-730,0,-91,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(120,-5548,1168,-1160,0,0,0,0x0, id_bhvMovingBlueCoin,31),
OBJECT_WITH_ACTS(118,-272,799,511,0,0,0,0x0, bhvMovingBlueCoin,31),
OBJECT_WITH_ACTS(129,-2364,662,-573,0,0,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(129,-2364,805,-730,-1,0,-1,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(137,-5382,875,-3890,0,0,0,0x60000, bhvExclamationBox,31),
OBJECT_WITH_ACTS(217,-1763,1071,-730,0,0,0,0x0, bhvPushableMetalBox,31),
OBJECT_WITH_ACTS(207,-5395,449,4122,0,0,0,0x0, bhvFloorSwitchAnimatesObject,31),
OBJECT_WITH_ACTS(187,-4408,406,4500,0,0,0,0x0, bhvButterfly,31),
OBJECT_WITH_ACTS(223,-975,437,511,0,0,0,0x0, bhvHomingAmp,31),
OBJECT_WITH_ACTS(85,4581,545,-6989,0,0,0,0x0, bhvYoshi,31),
OBJECT_WITH_ACTS(55,-3835,3348,-6647,0,0,0,0x0, bhvCastleFlagWaving,31),
OBJECT_WITH_ACTS(3,2351,2278,-5151,0,26,0,0x0, bhvStaticObject,31),
OBJECT_WITH_ACTS(3,-2351,2278,-5151,0,0,0,0x0, bhvStaticObject,31),
OBJECT_WITH_ACTS(85,-164,810,38,0,0,0,0x0, bhvYoshi,31),
OBJECT_WITH_ACTS(56,0,0,0,0,0,0,0x0, bhvHiddenAt120Stars,31),
OBJECT_WITH_ACTS(122,0,1023,-1619,0,0,0,0x0, bhvRecoveryHeart,31),
OBJECT_WITH_ACTS(3,0,4146,-3910,0,0,0,0x0, bhvStaticObject,31),
OBJECT_WITH_ACTS(0,-1364,336,4477,0,0,0,0x110000, bhvCoinFormation,31),
OBJECT_WITH_ACTS(137,-5382,875,-3890,0,0,360,0x60000, bhvExclamationBox,31),
OBJECT_WITH_ACTS(0,-1507,260,3961,0,30,0,0x10000, bhvGoombaTripletSpawner,31),
OBJECT_WITH_ACTS(137,-5382,875,-3890,0,0,0,0x60000, bhvExclamationBox,31),
OBJECT_WITH_ACTS(137,-5382,875,-3890,0,0,0,0x60000, bhvExclamationBox,31),
OBJECT_WITH_ACTS(137,-5382,875,-3890,0,0,0,0x60000, bhvExclamationBox,31),
OBJECT_WITH_ACTS(202,-1651,2246,-1977,0,-85,0,0x0, bhvCheckerboardElevatorGroup,31),
OBJECT_WITH_ACTS(129,-1437,2105,-1561,0,0,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(129,-1440,1974,-1410,0,0,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(207,-1443,2095,-1145,0,0,0,0x0, bhvFloorSwitchHiddenObjects,31),
OBJECT_WITH_ACTS(217,-1438,1784,-1155,0,0,0,0x0, bhvPushableMetalBox,31),
OBJECT_WITH_ACTS(0,-1443,1772,-644,0,0,0,0x0, bhvCheckerboardElevatorGroup,31),
OBJECT_WITH_ACTS(22,-1364,260,4477,0,0,0,0x0, bhvWarpPipe,31),
OBJECT_WITH_ACTS(54,0,0,0,0,0,0,0x0, bhvMoatGrills,31),
OBJECT_WITH_ACTS(0,-7430,1500,-5937,0,0,0,0x0, bhvAmbientSounds,31),
OBJECT_WITH_ACTS(220,-1945,260,4954,0,0,0,0x0, bhvGoomba,95),
OBJECT_WITH_ACTS(195,-2083,526,25,0,80,0,0x80000, bhvBobombBuddy,31),
OBJECT_WITH_ACTS(0,0,1500,0,0,0,0,0x0, bhvBirdsSoundLoop,31),
OBJECT_WITH_ACTS(129,-1971,1026,-730,0,92,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(0,4997,-1250,2258,0,210,0,0x1e0000, bhvSwimmingWarp,31),
OBJECT_WITH_ACTS(0,3552,1492,-5523,0,0,0,0x30000, bhvAirborneWarp,31),
OBJECT_WITH_ACTS(0,5408,4500,3637,0,225,0,0x140000, bhvAirborneWarp,31),
...
OBJECT_WITH_ACTS(0,-1369,1066,4488,0,180,0,0x40000, bhvSpinAirborneWarp,31),
OBJECT_WITH_ACTS(0,0,900,-1710,0,180,0,0xa0000, bhvDeathWarp,31),
        TERRAIN(/*terrainData*/ castle_grounds_seg7_collision_level),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0000, /*seq*/ 0x04),
