...
static const MacroObject local_macro_objects_castle_inside_1[] = {
    ...
    MACRO_OBJECT(/*preset*/ macro_yellow_coin_2,      /*yaw*/   0, /*pos*/  -1024,   388,  -210),
    MACRO_OBJECT(/*preset*/ macro_yellow_coin_2,      /*yaw*/   0, /*pos*/ -1024,   242,  -30),
    MACRO_OBJECT(/*preset*/ macro_yellow_coin_2,      /*yaw*/   0, /*pos*/  -1024,   547,  -640),
    MACRO_OBJECT(/*preset*/ macro_yellow_coin_2,      /*yaw*/   0, /*pos*/ -1024,   537,  -380),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_bouncing_fireball, /*yaw*/   90, /*pos*/  -1430,   390, -324, 0),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_bouncing_fireball,         /*yaw*/   270, /*pos*/  -618,   388, -324, /*behParam*/ 0),
MACRO_OBJECT_END(),
};
static const MacroObject local_macro_objects_castle_inside_2[] = {
MACRO_OBJECT_WITH_BEH_PARAM(macro_fake_star,       /*yaw*/  90, /*pos*/   -209,  2324,  2831,0),
MACRO_OBJECT_END(),
};
...
OBJECT_WITH_ACTS(0,1963,819,1280,0,0,0,0x50c0000, bhvWarp,31),
...
OBJECT_WITH_ACTS(221,596,-306,-2637,0,152,0,0x87000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(221,1524,307,458,0,110,0,0x86000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(221,-1671,0,1313,0,83,0,0x85000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(101,-1000,50,-3500,0,0,0,0x0, bhvBooInCastle,31),
OBJECT_WITH_ACTS(0,2778,507,1255,0,-90,0,0x0, bhvTankFishGroup,31),
OBJECT_WITH_ACTS(0,1884,873,-2723,0,50,0,0xf10000, bhvWarp,31),
OBJECT_WITH_ACTS(144,-618,434,-324,0,0,0,0x0, bhvFlame,31),
OBJECT_WITH_ACTS(144,-1430,434,-324,0,90,0,0x0, bhvFlame,31),
OBJECT_WITH_ACTS(101,-1024,697,-650,0,0,0,0x0, bhvBooInCastle,31),
...
OBJECT_WITH_ACTS(0,-230,4813,-3352,0,180,0,0x6b0000, bhvLaunchDeathWarp,31),
...
OBJECT_WITH_ACTS(0,-230,4813,-3352,0,0,0,0xf0b0000, bhvWarp,31),
OBJECT_WITH_ACTS(0,3002,2816,5886,0,0,0,0xf0a0000, bhvWarp,31),
OBJECT_WITH_ACTS(214,-127,3174,3772,0,180,0,0x46000000, bhvStarDoor,31),
OBJECT_WITH_ACTS(214,-281,3174,3772,0,0,0,0x46000000, bhvStarDoor,31),
...
OBJECT_WITH_ACTS(221,837,1203,3020,0,180,0,0x89000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(221,-1584,2253,7157,0,136,0,0x53000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(221,-977,1203,2569,0,0,0,0x4c000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(102,4231,1408,1601,0,0,0,0x0, bhvCameraLakitu,31),
...
OBJECT_WITH_ACTS(55,-205,2918,7222,0,180,0,0x0, bhvClockMinuteHand,31),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0001, /*seq*/ 0x04),
        TERRAIN_TYPE(/*terrainType*/ TERRAIN_STONE),
    END_AREA(),
...
OBJECT_WITH_ACTS(212,-854,-1218,2506,0,0,0,0x0, bhv1upSliding,31),
...
OBJECT_WITH_ACTS(221,-4048,-1381,-1334,0,30,0,0x88000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(221,1787,-1381,-1957,0,126,0,0x52000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(100,-1509,-1177,-1564,0,0,0,0x0, bhvMips,31),
OBJECT_WITH_ACTS(53,-1566,-1278,1800,0,0,0,0x0, bhvStaticObject,31),
OBJECT_WITH_ACTS(54,7066,-1178,-205,0,0,0,0x0, bhvWaterLevelPillar,31),
OBJECT_WITH_ACTS(54,7066,-1178,-819,0,0,0,0x0, bhvWaterLevelPillar,31),
