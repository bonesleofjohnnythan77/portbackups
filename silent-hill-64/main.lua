-- name: Silent Hill 64
-- description: Minihack by Apioeus with a slight ounce of Kaizo difficulty, has 1 course and 6 stars.\n\nPorted by B. Bones Johnson
...
smlua_audio_utils_replace_sequence(0x03, 0x1D, 75, "03_Seq_custom")
