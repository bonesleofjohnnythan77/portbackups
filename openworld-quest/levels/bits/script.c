...
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,65264,61536,0,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,3049,4623,64425,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,3049,4623,64625,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_recovery_heart,0,3678,2497,63916,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,1780,5432,64625,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,1300,2516,64404,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,1780,5432,64425,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,2849,4623,64625,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,2849,4623,64425,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,58536,2700,64646,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_goomba_triplet_spawner,0,60297,3839,64537,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,2206,5067,64425,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,2206,5067,64625,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_horizontal,0,1879,4639,63977,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,2406,5067,64625,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_recovery_heart,0,359,6099,62317,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,1580,5432,64425,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_horizontal,90,64736,63079,64736,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,350,6321,59524,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,350,6321,59524,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,350,6321,59524,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,350,6321,59524,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,350,6321,59524,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,350,6321,59524,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,350,6321,59524,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,1580,5432,64625,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,2406,5067,64425,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_circling_amp,0,4100,64216,63736,0),
MACRO_OBJECT_END(),
};
...
OBJECT_WITH_ACTS(0,353,6975,-6060,0,0,0,0x0, bhvBowserCourseRedCoinStar
,31),
...
,31),
OBJECT_WITH_ACTS(212,950,5881,-4630,0,0,0,0x0, bhv1Up
,31),
...
,31),
OBJECT_WITH_ACTS(63,27,25555,-713,0,90,0,0x10000, bhvSeesawPlatform
,31),
OBJECT_WITH_ACTS(207,350,6336,-6060,180,0,0,0x0, bhvFloorSwitchAnimatesObject
,31),
OBJECT_WITH_ACTS(207,-1342,3801,-900,0,0,0,0x0, bhvFloorSwitchHiddenObjects
,31),
OBJECT_WITH_ACTS(212,-250,5881,-4630,0,0,0,0x0, bhv1Up
,31),
OBJECT_WITH_ACTS(57,-4770,1732,-904,0,0,0,0x1000000, bhvOctagonalPlatformRotating
,31),
OBJECT_WITH_ACTS(57,353,4620,-6060,0,0,0,0x0, bhvOctagonalPlatformRotating
,31),
OBJECT_WITH_ACTS(57,4139,-1740,-1831,0,0,0,0x2000000, bhvOctagonalPlatformRotating
,31),
OBJECT_WITH_ACTS(55,-4700,23544,-904,0,180,0,0x8f0000, bhvSlidingPlatform2
,31),
OBJECT_WITH_ACTS(55,-2611,23544,-904,0,0,0,0xcf0000, bhvSlidingPlatform2
,31),
OBJECT_WITH_ACTS(54,1221,2224,-906,0,180,0,0xe0000, bhvSlidingPlatform2
,31),
OBJECT_WITH_ACTS(0,351,7216,-6060,0,180,0,0xc0000, bhvDeathWarp
,31),
OBJECT_WITH_ACTS(73,353,4925,-6060,0,0,0,0xb0000, bhvWarpPipe
,31),
OBJECT_WITH_ACTS(0,-7039,-3812,4,0,90,0,0xa0000, bhvAirborneWarp
,31),
        TERRAIN(/*terrainData*/ bits_seg7_collision_level),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0000, /*seq*/ 44),
