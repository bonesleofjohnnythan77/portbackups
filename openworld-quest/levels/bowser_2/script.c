...
WARP_NODE(240,15,1,11,0),
WARP_NODE(10,33,1,10,0),
OBJECT_WITH_ACTS(179,-3584,1300,0,0,90,0,0x0, bhvBowserBomb,31),
OBJECT_WITH_ACTS(179,0,1300,-3584,0,90,0,0x0, bhvBowserBomb,31),
OBJECT_WITH_ACTS(179,3584,1300,0,0,90,0,0x0, bhvBowserBomb,31),
OBJECT_WITH_ACTS(179,0,1300,3584,0,90,0,0x0, bhvBowserBomb,31),
OBJECT_WITH_ACTS(54,0,-1300,0,0,90,0,0x0, bhvTiltingBowserLavaPlatform,31),
OBJECT_WITH_ACTS(0,0,900,0,0,180,0,0xa0000, bhvSpinAirborneCircleWarp,31),
        TERRAIN(/*terrainData*/ bowser_2_seg7_collision_lava),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0002, /*seq*/ 57),
