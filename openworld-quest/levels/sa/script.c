...
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,63136,65336,63136,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,63136,65336,2400,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,2400,65336,2400,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,2400,65336,63136,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,0,60929,64036,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,64036,60929,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,0,60929,1500,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,1500,60929,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fish_group,0,1927,62627,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_vertical,90,1000,60929,64536,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_vertical,0,64536,60929,64536,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_vertical,90,64536,60929,1000,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_vertical,0,1000,60929,1000,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up_trigger,0,0,236,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up,0,0,108,0,1),
...
OBJECT_WITH_ACTS(0,0,-4250,0,0,0,0,0x0, bhvHiddenRedCoinStar
,31),
OBJECT_WITH_ACTS(0,0,-2000,0,0,90,0,0xa0000, bhvSwimmingWarp
,31),
        TERRAIN(/*terrainData*/ sa_seg7_collision),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0003, /*seq*/ (56 | SEQ_VARIATION)),
