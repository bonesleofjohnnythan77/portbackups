...
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,0,666,65332,4567,75),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_vertical,0,3141,1147,147,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,665,3277,263,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,62397,1126,5564,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,63581,65349,5091,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,2950,815,64286,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,63544,1033,779,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,63467,1033,2011,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,63986,0,65046,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,64372,60,2323,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_floor_switch_hidden_objects,0,2955,62571,1875,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,65331,62778,205,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,64781,62778,65181,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,64781,62778,755,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,355,62778,755,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,355,62778,65181,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,656,2535,4532,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_ring_horizontal,0,480,10,64883,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_mr_i,0,65331,62816,205,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,0,63487,991,1080,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_scuttlebug,0,3466,65332,5106,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_mr_i,0,64781,62816,755,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_metal_cap,0,63576,300,65416,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,656,2535,4732,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_mr_i,0,355,62816,755,0),
MACRO_OBJECT_END(),
};
...
OBJECT_WITH_ACTS(0,666,1681,5350,0,180,0,0xa0000, bhvSpinAirborneCircleWarp,31),
OBJECT_WITH_ACTS(207,1153,1741,-334,0,270,0,0x0, bhvFloorSwitchHiddenObjects,31),
OBJECT_WITH_ACTS(0,-204,1100,1576,0,0,0,0x3000000, bhvHiddenRedCoinStar,31),
OBJECT_WITH_ACTS(0,1105,-2055,1810,0,0,0,0x2000000, bhvHiddenStar,31),
...
OBJECT_WITH_ACTS(0,-818,890,-686,0,270,0,0x0, bhvHauntedBookshelf,31),
OBJECT_WITH_ACTS(0,-1330,890,-622,0,90,0,0x0, bhvHauntedBookshelf,31),
OBJECT_WITH_ACTS(0,-818,890,-200,0,270,0,0x0, bhvHauntedBookshelf,31),
OBJECT_WITH_ACTS(0,-1330,890,200,0,90,0,0x0, bhvHauntedBookshelf,31),
...
OBJECT_WITH_ACTS(122,2955,-2990,1875,0,-90,0,0x4000000, bhvStar,31),
...
OBJECT_WITH_ACTS(129,654,2290,3780,0,0,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(122,656,3053,4840,0,0,0,0x5000000, bhvStar,31),
OBJECT_WITH_ACTS(129,654,2003,3072,0,0,0,0x0, bhvHiddenObject,31),
OBJECT_WITH_ACTS(0,-755,-2751,-355,0,0,0,0x0, bhvMrI,31),
OBJECT_WITH_ACTS(0,355,-2751,-355,0,0,0,0x0, bhvMrI,31),
...
OBJECT_WITH_ACTS(0,666,921,3500,0,180,0,0xf00000, bhvAirborneStarCollectWarp,31),
...
OBJECT_WITH_ACTS(144,2089,1331,-1125,0,270,0,0x0, bhvFlame,31),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0006, /*seq*/ 12),
