...
const Collision bowser_3_seg7_collision_level[] = {
    ...
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/ -3362,  -404,  1121, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/     0,  -404,  3584, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/  3362,  -404,  1126, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/  2123,  -404, -2912, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/ -2122,  -404, -2912, /*yaw*/    0),
    COL_END(),
};
