...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up_trigger,0,588,102,64338,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up_trigger,0,64948,102,64338,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up_trigger,0,588,102,63237,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up_trigger,0,64948,102,63237,0),
MACRO_OBJECT_END(),
};
...
WARP_NODE(1,6,1,12,0),
WARP_NODE(11,26,1,11,0),
WARP_NODE(10,26,1,10,0),
WARP_NODE(5,12,1,10,0),
OBJECT_WITH_ACTS(0,0,205,-1735,0,0,0,0x4c000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(217,-23,-293,-3610,0,0,0,0x0, bhvPushableMetalBox,31),
...
OBJECT_WITH_ACTS(0,0,600,-3000,0,180,0,0xb0000, bhvDeathWarp,31),
OBJECT_WITH_ACTS(0,0,600,-3000,0,0,0,0xa0000, bhvAirborneStarCollectWarp,31),
OBJECT_WITH_ACTS(139,-23,20,-3650,90,0,0,0x4050000, bhvWarp,31),
        TERRAIN(/*terrainData*/ castle_courtyard_seg7_collision),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0000, /*seq*/ 35),
