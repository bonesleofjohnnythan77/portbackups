...
MACRO_OBJECT_WITH_BEH_PARAM(macro_goomba_triplet_spawner,261,5558,722,63689,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_goomba_triplet_spawner,90,60781,436,4421,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,0,63970,260,3503,30),
MACRO_OBJECT_WITH_BEH_PARAM(macro_goomba_triplet_spawner,81,60870,260,922,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,2,64069,213,5747,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,0,4214,1388,59539,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,0,4214,1695,59539,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,0,4214,2002,59539,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_goomba_triplet_spawner,0,5012,1078,59818,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,11,6246,64097,1965,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,11,6345,64403,1906,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_cannon_open,0,2384,70,1961,64),
MACRO_OBJECT_WITH_BEH_PARAM(macro_goomba_triplet_spawner,0,59296,295,320,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_goomba_triplet_spawner,0,6330,710,61776,0),
MACRO_OBJECT_END(),
};
...
WARP_NODE(2,6,3,2,0),
WARP_NODE(1,6,1,11,0),
WARP_NODE(0,6,1,10,0),
WARP_NODE(241,16,1,3,0),
OBJECT_WITH_ACTS(100,0,3174,-5625,0,0,0,0x0, bhvMips,31),
OBJECT_WITH_ACTS(187,-1204,326,3296,0,0,0,0x0, bhvButterfly,31),
OBJECT_WITH_ACTS(124,2566,103,2174,0,270,0,0x1b0000, bhvMessagePanel,31),
OBJECT_WITH_ACTS(0,0,1132,500,0,0,0,0x6000000, bhvBowserCourseRedCoinStar,31),
OBJECT_WITH_ACTS(215,-1467,530,5746,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(215,-6320,543,-4272,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(215,0,150,-270,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(215,5760,-1330,5199,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(215,-6220,1115,3458,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(215,-4165,-1228,-4656,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(215,4700,545,-7609,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(215,6178,875,167,0,0,0,0x0, bhvRedCoin,31),
OBJECT_WITH_ACTS(195,-1773,256,3590,0,0,0,0x30000, bhvBobombBuddy,31),
...
OBJECT_WITH_ACTS(0,-1328,260,4664,0,180,0,0x70000, bhvSwimmingWarp,31),
OBJECT_WITH_ACTS(217,6270,-1187,1950,0,31,345,0x0, bhvPushableMetalBox,31),
OBJECT_WITH_ACTS(84,-4711,742,433,0,0,0,0x10000, bhvBird,31),
OBJECT_WITH_ACTS(84,-5069,850,3221,0,0,0,0x10000, bhvBird,31),
...
OBJECT_WITH_ACTS(22,6154,-1030,2021,72,301,0,0x1e0000, bhvWarpPipe,31),
OBJECT_WITH_ACTS(0,-6901,2576,-6509,0,50,0,0x140000, bhvAirborneWarp,31),
OBJECT_WITH_ACTS(139,2425,0,1978,90,270,0,0xa0000, bhvWarp,31),
OBJECT_WITH_ACTS(0,2138,604,2806,0,270,0,0x80000, bhvAirborneStarCollectWarp,31),
OBJECT_WITH_ACTS(0,-4,7900,-4020,0,2,0,0x20000, bhvFadingWarp,31),
OBJECT_WITH_ACTS(0,2138,604,2806,0,90,0,0x30000, bhvDeathWarp,31),
OBJECT_WITH_ACTS(22,-1476,350,5607,270,4,0,0x50000, bhvWarpPipe,31),
OBJECT_WITH_ACTS(0,-1328,260,4664,0,180,0,0x40000, bhvSpinAirborneCircleWarp,31),
OBJECT_WITH_ACTS(0,5598,-865,2353,0,300,0,0x60000, bhvSwimmingWarp,31),
