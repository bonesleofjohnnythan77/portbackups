...
MACRO_OBJECT_WITH_BEH_PARAM(macro_yellow_coin,0,63691,62756,64821,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_yellow_coin,0,62570,62756,64821,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_horizontal_flying,0,1130,62536,400,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up,0,1200,5478,80,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,2340,62772,580,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_circling_amp,0,63211,3990,0,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up,0,2450,3795,100,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_one_coin,0,2450,5520,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up_3,0,1198,5078,103,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,4044,4411,93,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up_3,0,65362,62496,65398,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,0,0,0,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_circling_amp,0,63211,3990,0,2),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,58416,2760,520,0),
MACRO_OBJECT_END(),
};
...
,31),
OBJECT_WITH_ACTS(63,2103,-20198,312,0,0,0,0x19f0000, bhvSlidingPlatform2
,31),
OBJECT_WITH_ACTS(62,-3276,702,2,180,270,0,0x10c0000, bhvSlidingPlatform2
,31),
OBJECT_WITH_ACTS(62,-3890,702,617,180,90,0,0x10c0000, bhvSlidingPlatform2
,31),
...
,31),
OBJECT_WITH_ACTS(59,2867,-21279,307,0,0,0,0x29f0000, bhvActivatedBackAndForthPlatform
,31),
OBJECT_WITH_ACTS(58,3072,-23584,96,0,0,0,0x10000, bhvBitfsSinkingCagePlatform
,31),
OBJECT_WITH_ACTS(58,614,-23584,96,0,0,0,0x10000, bhvBitfsSinkingCagePlatform
,31),
OBJECT_WITH_ACTS(58,1843,-23584,96,0,0,0,0x10000, bhvBitfsSinkingCagePlatform
,31),
OBJECT_WITH_ACTS(58,-2305,3284,96,0,0,0,0x0, bhvBitfsSinkingCagePlatform
,31),
OBJECT_WITH_ACTS(56,-3250,3457,96,0,0,-4,0x0, bhvBitfsSinkingPlatforms
,31),
OBJECT_WITH_ACTS(56,1126,-3085,307,0,0,0,0x0, bhvBitfsSinkingPlatforms
,31),
OBJECT_WITH_ACTS(56,-1381,3457,96,0,0,4,0x0, bhvBitfsSinkingPlatforms
,31),
OBJECT_WITH_ACTS(55,-2966,-3225,-715,0,0,0,0x0, bhvBitfsTiltingInvertedPyramid
,31),
OBJECT_WITH_ACTS(55,-1845,-3225,-715,0,0,0,0x0, bhvBitfsTiltingInvertedPyramid
,31),
OBJECT_WITH_ACTS(116,-5733,-23071,0,0,0,0,0x0, bhvOneCoin
,31),
OBJECT_WITH_ACTS(0,-7577,-1764,0,0,90,0,0xf10000, bhvDeathWarp
,31),
...
,31),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0000, /*seq*/ 47),
