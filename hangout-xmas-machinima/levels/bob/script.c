...
const LevelScript level_xmas_machinima_entry[] = {
INIT_LEVEL(),
...
TERRAIN(col_bob_1_0xe0a64a8),
SET_BACKGROUND_MUSIC(0,0x4A),
TERRAIN_TYPE(2),
...
,31),
OBJECT_WITH_ACTS(85,-34,-1507,-5274,0,-168,0,0x0, bhvYoshi
,31),
...
,31),
OBJECT_WITH_ACTS(22,-3508,-2025,6554,0,0,0,0x70000, bhvWarpPipe,31),
OBJECT_WITH_ACTS(0,-151,-1931,-2115,0,0,0,0x80000, bhvDeathWarp,31),
OBJECT_WITH_ACTS(0,-102,-1501,-5106,0,180,0,0x11000, bhvLaunchStarCollectWarp,31),
OBJECT_WITH_ACTS(124,-3497,-2024,6300,0,180,0,0x00A70000, bhvMessagePanel,31),
RETURN()
};
...
WARP_NODE(240,LEVEL_XMAS_MACHINIMA,1,9,0),
WARP_NODE(241,LEVEL_XMAS_MACHINIMA,1,8,0),
...
WARP_NODE(8,LEVEL_XMAS_MACHINIMA,1,8,0),
WARP_NODE(16,LEVEL_XMAS_MACHINIMA,1,16,0),
RETURN()
};
