smlua_text_utils_dialog_replace(DIALOG_000,1,4,30,200, ("Oh look!\
Waluigi is at the casino.\
Wonder what he's up\
to this time?"))
...
smlua_text_utils_dialog_replace(DIALOG_008,1,5,30,200, ("This is the taco stand!\
You will be taking\
customer's orders.\
Try your best to\
satisfy them.\
...
smlua_text_utils_dialog_replace(DIALOG_015,1,3,30,200, ("It appears that\
he is angry\
at the slots."))
...
smlua_text_utils_dialog_replace(DIALOG_018,1,5,30,200, ("Welcome to the\
Taco Fields!\
\
\
\
...
『serve taco』 in the\
pause menu.\
If you collected only\
the correct ingredients,\
you'll make an amazing\
taco!"))

smlua_text_utils_dialog_replace(DIALOG_019,1,3,30,200, ("Hi, I'd like a taco\
with lettuce and\
beef please."))
...
smlua_text_utils_dialog_replace(DIALOG_024,1,5,95,200, ("You messed up my\
taco!!\
Those are the wrong\
ingredients.\
Try again!"))

smlua_text_utils_dialog_replace(DIALOG_025,1,4,95,200, ("That's not my taco!\
The ingredients are all\
wrong!!\
Please try again."))

smlua_text_utils_dialog_replace(DIALOG_026,1,2,95,200, ("That wasn't my order!\
You lose, try again..."))

smlua_text_utils_dialog_replace(DIALOG_027,1,4,95,200, ("blargh...\
The taco is all wrong!\
Please make me\
another one..."))

smlua_text_utils_dialog_replace(DIALOG_028,1,4,95,200, ("This taco is disgusting!\
It's all messed up!\
Please pick the right\
ingredients..."))

smlua_text_utils_dialog_replace(DIALOG_029,1,3,95,200, ("That's not the taco\
I ordered!!\
Do it again."))

smlua_text_utils_dialog_replace(DIALOG_030,1,6,30,200, ("Hello, I'll take\
one healthy taco\
with lettuce, tomato\
and mushrooms please."))
...
smlua_text_utils_dialog_replace(DIALOG_032,1,5,30,200, ("Hey, I'd like a\
big, tasty taco.\
Only cheese and\
beef please."))

smlua_text_utils_dialog_replace(DIALOG_033,1,5,30,200, ("Congratulations!\
You've upped your\
Taco - Rank and\
advanced to the\
next level!\
...
smlua_text_utils_dialog_replace(DIALOG_035,1,3,30,200, ("Hi!\
I'd like a taco with\
only fish in it!"))

smlua_text_utils_dialog_replace(DIALOG_036,1,3,30,200, ("Uukee - kee!\
I want a taco with\
coconut and beef!"))
...
smlua_text_utils_dialog_replace(DIALOG_039,1,4,30,200, ("Hello, please don't judge\
me for this, but\
I'd like a taco full\
of garlic - only garlic."))

smlua_text_utils_dialog_replace(DIALOG_040,1,2,30,200, ("Hello, one taco with\
cheese and beef please."))

smlua_text_utils_dialog_replace(DIALOG_041,1,5,30,200, ("Hey Waluigi,\
your rent is due.\
\
\
\
You can't pay up\
after you've lost all\
of your and Wario's\
money at the casino.\
\
...
smlua_text_utils_dialog_replace(DIALOG_042,1,5,30,200, ("One complete taco\
please.\
I want the full buffee.\
Coconut, fish, beef,\
cheese and garlic."))

smlua_text_utils_dialog_replace(DIALOG_043,1,3,30,200, ("Hi, I'd like a standard\
lettuce, cheese and beef\
taco."))
...
smlua_text_utils_dialog_replace(DIALOG_046,1,3,30,200, ("One herbivore taco\
with lettuce, tomato\
and cactus please."))
...
smlua_text_utils_dialog_replace(DIALOG_048,1,4,30,200, ("Man, I hate chicken!\
One taco with only\
chicken please.\
I'm gonna eat all of them."))

smlua_text_utils_dialog_replace(DIALOG_049,1,4,30,200, ("Hi, one koopa special\
with lots of cactus,\
tomato and cheese\
please."))

smlua_text_utils_dialog_replace(DIALOG_050,1,4,30,200, ("I want to crush something!\
Give me a taco with\
chicken and beef and\
leave some bone in for me!"))

smlua_text_utils_dialog_replace(DIALOG_051,1,4,30,200, ("One generic taco for\
a generic goomba\
on a generic day.\
Lettuce, tomato, beef."))

smlua_text_utils_dialog_replace(DIALOG_052,1,4,30,200, ("It's me, Mr Rent!\
It seems you've done a\
great job serving those\
tacos.\
Thanks for your service,\
Waluigi!\
This will easily cover\
your rent.\
You're a winner!"))

smlua_text_utils_dialog_replace(DIALOG_053,1,5,30,200, ("Hi, I want the full\
volcano taco.\
Spiderlegs, beef,\
spicey sauce,  eyeballs\
and bully horns."))
...
smlua_text_utils_dialog_replace(DIALOG_160,1,4,30,200, ("Hey I'm feeling pretty\
skinny today,\
One taco with\
only lettuce please."))

smlua_text_utils_dialog_replace(DIALOG_161,1,4,30,200, ("Yo!\
I want a taco with beef,\
fresh lettuce and\
juicy tomatos!"))

smlua_text_utils_dialog_replace(DIALOG_162,1,4,30,200, ("At last...\
A taco worthy of battle.\
Fill it with eyeballs, \
and bully horns.\
Then drown it in\
spicy sauce."))

smlua_text_utils_dialog_replace(DIALOG_163,1,4,30,200, ("Ooh, island vibes today!\
Give me a taco with\
some coconuts and garlic.\
Don't forget the garlic!"))

smlua_text_utils_dialog_replace(DIALOG_164,1,3,30,200, ("Just the spicy sauce.\
No meat. No toppings.\
Drown the shell in fire."))

smlua_text_utils_dialog_replace(DIALOG_165,1,5,30,200, ("Keep it simple.\
One taco.\
Only beef. Nothing else."))

smlua_text_utils_dialog_replace(DIALOG_166,1,4,30,200, ("Cheese and garlic.\
Melt it together,\
and don't hold back."))

smlua_text_utils_dialog_replace(DIALOG_167,1,4,30,200, ("You know the deal.\
Grilled chicken and\
melted cheese.\
