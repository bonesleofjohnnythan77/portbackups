...
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ 223, -3261, -4281),
	TRAJECTORY_POS(1, /*pos*/ 257, -3261, -7206),
	TRAJECTORY_POS(2, /*pos*/ 2009, -2835, -7206),
	TRAJECTORY_POS(3, /*pos*/ 2982, -3432, -7206),
	TRAJECTORY_POS(4, /*pos*/ 4728, -3018, -7206),
	TRAJECTORY_POS(5, /*pos*/ 4728, -3018, -3620),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702ECC0_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ 1776, -436, -8245),
	TRAJECTORY_POS(1, /*pos*/ 1176, -436, -10521),
	TRAJECTORY_POS(2, /*pos*/ 2858, -436, -11616),
	TRAJECTORY_POS(3, /*pos*/ 4895, -436, -10819),
	TRAJECTORY_POS(4, /*pos*/ 5762, -436, -9485),
	TRAJECTORY_END(),
};
