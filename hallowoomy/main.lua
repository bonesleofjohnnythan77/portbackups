-- name: \\#E70000\\Hallowoomy \\#CE6F00\\on \\#A900D6\\Spoopy \\#BE0175\\Island
-- description: A short, spooky-themed hack set in and around a haunted castle, created by BroDute to celebrate Halloween 2015\n\nPorted by B. Bones Johnson
...
smlua_audio_utils_replace_sequence(0x03, 0x12, 75, "03_Seq_custom")
...
smlua_audio_utils_replace_sequence(0x07, 0x1D, 75, "07_Seq_custom")
...
smlua_audio_utils_replace_sequence(0x21, 0x1D, 75, "21_Seq_custom")
smlua_audio_utils_replace_sequence(0x24, 0x25, 75, "24_Seq_custom")
smlua_audio_utils_replace_sequence(0x26, 0x1D, 75, "26_Seq_custom")
