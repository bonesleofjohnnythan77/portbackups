...
TERRAIN(col_bowser_1_1_0xe0052a8),
...
OBJECT_WITH_ACTS(0,-2334,17,2874,0,0,0,0xa0000, bhvSpinAirborneWarp,31),
OBJECT_WITH_ACTS(100,-308,-1031,3329,0,-105,0,0x0, bhvBowser,31),
OBJECT_WITH_ACTS(101,-778,-849,-4571,0,-167,0,0x0, bhvBowserBomb,31),
...
OBJECT_WITH_ACTS(0,16,5,96,6,0,0,4,editor_Scroll_Texture,31),
RETURN()
};
