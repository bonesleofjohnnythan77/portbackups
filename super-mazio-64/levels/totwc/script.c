...
OBJECT_WITH_ACTS(0,-4244,6,-4255,0,0,0,0xa0000, bhvSpinAirborneWarp
,31),
OBJECT_WITH_ACTS(85,0,6,0,0,0,0,0x0, bhvCapSwitch
,31),
OBJECT_WITH_ACTS(122,-3769,256,1756,0,0,0,0x0, bhvStar
,31),
RETURN()
};
