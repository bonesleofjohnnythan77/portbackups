-- name: \\#59B161\\Super Mazio 64
-- description: A romhack created by by IngoH that converts every level of the game into a giant maze. There are 106 stars total.\n\nNote: Course 10's 6th Star and Rainbow Clouds stars are both Unobtainable.\n\n Ported by B. Bones Johnson
...
vec3f_set(gLevelValues.starPositions.PssSlideStarPos, -1250.0, 256.0, -5750.0)
