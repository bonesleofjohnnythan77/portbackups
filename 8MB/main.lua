-- name: \\#0A8DFF\\Super Mario \\#FFFF00\\8MB\\#FFCD00\\
-- description: An old demo of Team Cornersoft's Super Mario Sunshine-inspired hack, made for the SMWcentral Summer C3 2017.\n\n The hack would later turn into Super Mario Q and this demo only has 12 stars. \n \n Ported by B. Bones Johnson
...
smlua_audio_utils_replace_sequence(0x2B, 0x0D, 75, "2B_Seq_custom")
...
vec3f_set(gLevelValues.starPositions.PssSlideStarPos, 6460.0, 715.0, -1710.0)
...
vec3f_set(gLevelValues.starPositions.BalconyBooStarPos, -5645.0, 1153.0, -4987.0)
