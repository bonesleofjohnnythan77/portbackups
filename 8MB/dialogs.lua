smlua_text_utils_dialog_replace(DIALOG_000,2,6,95,200, (" ---- IMPORTANT! ----\
Due to how the 2D hub\
works, Lakitu's camera\
will transfer over to the\
stages. At each entry of\
one, press R to correct it.\
You will respawn in the\
levels themselves. Use the\
provided exit (or use the \
exit stage option in the \
pause menu) to leave after \
clearing a mission.\
Each act has important\
changes to them, so make\
sure that you exit the\
stage and re-enter again\
to select another mission.\
Secret stages excluded.\
   ---- Credits ----\
Level design: Mel (Bl.St.)\
Fonts: Quasmok\
Music: Pablo's Corner\
Textures: Nintendo, Rare,\
Mel (Bl.St.), Quasmok\
---- Special Thanks ----\
More Objects Patch: Kaze\
Handy tools: Pilzinsel\
GUI help: Shygoo\
Other: Skelux, MrPr1993,\
Team Cornersoft"))

smlua_text_utils_dialog_replace(DIALOG_001,2,6,95,200, ("Welcome to the demo\
exclusive secret level!\
This level was basically\
the testing ground to test\
a few gimmicks, but I \
didn't want to remove it. \
And now I made a level \
out of it! It's not going \
to be very an easy ride, \
but if I can master a \
deathless run with a \
keyboard, so can you!\
...
smlua_text_utils_dialog_replace(DIALOG_002,2,6,95,200, ("Can't reach the platform\
up ahead? Why not climb\
one of the trees nearby?\
You can leap from the\
leaves on to the platform\
with ease!"))

smlua_text_utils_dialog_replace(DIALOG_003,2,6,95,200, ("   ---- Notice ----\
When you strike gold or\
loose your way, you will\
restart from this location.\
Your progress won't be in\
vain.\
However, sometimes it's\
handy to leave the place\
and come back again \
with a different objective \
in mind. \
(Press 0START0 and exit\
the level and select a\
different act to hunt for\
act exclusive stars!)"))
...
smlua_text_utils_dialog_replace(DIALOG_013,1,5,30,200, ("You have collected 100\
coins! You gained an\
island star! Wanna save?\
\
//Yes////No"))

smlua_text_utils_dialog_replace(DIALOG_014,1,4,30,200, ("Congratulations on finding\
a star!\
\
Do you want to Save?\
\
...
smlua_text_utils_dialog_replace(DIALOG_143,1,6,150,200, ("You are almost there,\
only a few more stars to\
go. After that, why don't\
you reflect on your\
adventure?"))
