...
OBJECT_WITH_ACTS(0,0,160,0,0,0,0,0xa0000, bhvAirborneStarCollectWarp,31),
OBJECT_WITH_ACTS(0,72,-702,-3378,0,-154,0,0x14000000, bhvWarp,31),
OBJECT_WITH_ACTS(122,2,241,2816,0,-153,0,0x0, bhvStar,31),
OBJECT_WITH_ACTS(0,71,-669,-3470,0,178,0,0x0, bhvScuttlebugSpawn,31),
OBJECT_WITH_ACTS(0,-82,288,-85,0,0,0,0x20000, bhvDeathWarp,31),
RETURN()
};
...
WARP_NODE(240,5,1,10,0),
WARP_NODE(241,5,1,2,0),
