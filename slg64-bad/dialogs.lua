smlua_text_utils_dialog_replace(DIALOG_000, 1, 6, 30, 200, ("Luigi Bros de Mario42Gls42\
je te souhaite la bienvenue\
dans super luigi galaxy 64\
demo 2.0 vous commencez \
depuis la carpette de\
depart voici les changements\
de la 2.0[C]\
-Textures Super Mario Maker\
-Arriver Super Mario Galaxy\
-reparation du niveau custo\
mise monde retro\
-Nouvelles Musiques\
-Ajout de Zowser\
-Correction de la\
musique Thrillville le\
parc en folie Funhouse\
attraction theme.m64\
et c'est tout."))
smlua_text_utils_dialog_replace(DIALOG_001, 1, 4, 95, 200, ("Dans super luigi galaxy 64\
demo 1.0 ont avait creer\
la texture super mario\
maker au commencement et\
ca va continuer puis ont\
a mis la suite des \
textures hacks et inserer\
les musiques customisees.\
dit-moi si l'arriere-plan\
du niveau te plait[C]\
A[C]il me plait\
B[C]il me plait pas\
merci quand meme."))
smlua_text_utils_dialog_replace(DIALOG_002, 1, 4, 95, 200, ("luigi bros de mario42gls42\
est-tu venu voir mamy toad\
il parait quelle est sympa\
thique comme vielle dame."))
smlua_text_utils_dialog_replace(DIALOG_003, 1, 5, 95, 200, ("Bonjour luigi bros de mario\
42gls42 je suis mamy toad \
et je vis dans cette maison"))
smlua_text_utils_dialog_replace(DIALOG_004, 1, 3, 95, 200, ("Fait attention Luigi Bros\
de Mario42Gls42 nous les\
bobs-ombs gentilles vertes\
sont en guerre contre les\
mechantes bobs-ombs oranges."))
...
it, fair and square!"))
smlua_text_utils_dialog_replace(DIALOG_008, 1, 4, 30, 200, ("luigi bros de mario42gls42\
je te souhaite la bienvenue\
dans la boite minis-jeux il\
...
\
//Yes////No"))
smlua_text_utils_dialog_replace(DIALOG_012, 1, 4, 30, 200, ("Bienvenue dans la boite\
minis-jeux."))
...
press [B] again."))
smlua_text_utils_dialog_replace(DIALOG_016, 1, 3, 30, 200, ("Je te souhaite bonne\
chance Luigi Bros\
de Mario42Gls42 pour\
vaincre la seconde\
Zowser."))
smlua_text_utils_dialog_replace(DIALOG_017, 1, 4, 30, 200, ("Je suis le roi troll-omb\
seigneur inconteste des\
blagues hahaha incroyable\
tu est venu ici en salop\
ette verte fluo avec la\
moustache j'admire ton\
courage pour me battre\
mais si tu veux avoir\
l'etoile il faudrait me\
battre mes petites bobs-\
ombs oranges vont te\
donner une bonne raclee\
maintenant en GARDE!!!!!"))
...
smlua_text_utils_dialog_replace(DIALOG_020, 1, 6, 95, 150, ("Luigi Bros de Mario42Gls\
42 voici la maison de to\
ad qui te presente un au\
tre acces dans la boite\
minis-jeux voici les mi\
nis-jeux que tu peux joue\
r[C]\
-Tape-Taupe\
-Hockey Sur Glace |Mario\
Version>\
-Plateformes Ecroulantes\
-La Couse De La Grenoui\
lle\
-Fracas et Patatras\
et Vol D'Oiseau\
fait tes jeux.\
...
Maybe it's for the\
basement..."))
smlua_text_utils_dialog_replace(DIALOG_024, 1, 5, 95, 200, ("etoile pour ouvrir cette\
porte"))
smlua_text_utils_dialog_replace(DIALOG_025, 1, 4, 95, 200, ("etoiles pour ouvrir cette\
porte"))
smlua_text_utils_dialog_replace(DIALOG_026, 1, 4, 95, 200, ("Oh non!!! tu vas decouvrir\
ma maison si tu recolte 8\
etoiles je t'interdis d'en\
prendre 8 sinon gare aux\
blessures signee\
~Zowser~\
"))
...
door. You need ^ more\
Stars."))
smlua_text_utils_dialog_replace(DIALOG_029, 1, 5, 95, 200, ("C'est un piege hahaha tu\
decouvrira jamais mon\
chateau normalement pour\
le dernier combat je suis\
tout au sommet de la tour\
mais pas cette fois ci.Cet\
te fois je suis dans une\
course secrete et tu bata\
illera a la trouver bwabwah\
gwagwahhaha signee\
~Zowser~ \
 \
"))
...
around. Now, head for\
the castle."))
smlua_text_utils_dialog_replace(DIALOG_034, 1, 6, 30, 200, ("Welcome in the minis-games\
box."))
...
smlua_text_utils_dialog_replace(DIALOG_047, 1, 2, 95, 200, ("Je te prepare un canon\
patiente..."))
...
Star instead. You've\
earned it!"))
smlua_text_utils_dialog_replace(DIALOG_057, 1, 4, 30, 200, ("Paggy Pingouin mon bebe\
ou-est tu?"))
smlua_text_utils_dialog_replace(DIALOG_058, 1, 4, 30, 200, ("Paggy Pingouin mon bebe\
tonton Luigi Bros de\
Mario42Gls42 t'as retrou\
ver je suis contente quant\
a toi Luigi Bros de Mario\
42Gls42 comment exprimer\
ton eternel gratitude."))
...
smlua_text_utils_dialog_replace(DIALOG_067, 1, 5, 30, 200, ("Tu est bien le Luigi Bros\
de Mario42Gls42 tu as \
decouvert ma maison je\
suis tres en colere je\
vais malheuresement \
devoir te DETRUIRE!!!\
bwabwahgwagwahhaha."))
...
Here, Mario, catch!"))
smlua_text_utils_dialog_replace(DIALOG_084, 1, 3, 30, 200, ("Bonjour luigi bros de mario\
42gls42 je suis Blu le \
lapin de garde de mamy\
toad et cette derniere\
m'a dit que je dois te\
donner une etoile gratuite\
ment pour te faire plaisir\
et j'ai accepter tiens \
PRENDS CA!!!! a plus."))
...
Right[C] Work Elevator\
/// Cloudy Maze\
Left[C] Black Hole\
///Underground Lake\
\
Red Circle[C] Elevator 2\
//// Underground Lake\
Arrow[C] You are here"))
...
comfy ride."))
smlua_text_utils_dialog_replace(DIALOG_092, 1, 5, 30, 200, ("Zowser te prepare des\
niveaux plus dur tu\
peut passer le texte\
avec[A] ou [B] ecoute \
bien[C]\
-Zowser[C] Alors Klepto\
tu as reussi a pieger\
luigi bros de Mario42\
Gls42?\
-Klepto[C]Non desoler\
maitre\
-Zowser[C]Mais alors\
quand tu me le\
bloquera ? stupide\
soldat\
-Klepto[C] Peut etre oui\
peut etre non je le\
bloquerais bientot \
promis maitre\
-Zowser[C]Oui ou Non?\
...
-R-E !!!!\
-Klepto[C] Mais Mais !!\
-Zowser[C] si tu ne me\
le bloque pas avant\
qui accede a mon\
chateau car la il est\
dans mon vaisseau\
tu seras VIREE!!!\
-Klepto[C] Oui Oui bien\
sur maitre\
-Zowser[C] merci\
-Zowser[C] bwabwahgwagwahha\
ha Luigi Bros de Mario42\
Gls42 est maintenant\
pieger hahahaha!!!!.\
FIN"))
...
to land."))
smlua_text_utils_dialog_replace(DIALOG_106, 1, 2, 95, 200, ("Canon pret a tirer"))
...
Take this with you!"))
smlua_text_utils_dialog_replace(DIALOG_116, 1, 5, 95, 200, ("Comment c'est possible un\
plombier en salopette verte\
fluo a battu le roi troll-\
omb il ne gagnera jamais\
ses blagues ? prochain\
combat ce sera dur tres \
tres dur ciao Luigi Bros\
de Mario42Gls42."))
...
We...sleep...darkness."))
smlua_text_utils_dialog_replace(DIALOG_119, 1, 6, 30, 200, ("C'est pas vrai tu m'a battu\
j'arrive pas a le croire\
grouaaaaaaaaa tu as battu\
le 1er Zowser l'equipe gls\
te felicite pour cela \
trouve le custom powerup\
champignon poison dans\
les prochains niveaux pour\
te feliciter."))
...
Right[C] Work Elevator\
/// Cloudy Maze\
Left[C] Underground Lake"))
smlua_text_utils_dialog_replace(DIALOG_123, 1, 4, 30, 200, ("Metal Cavern\
Right[C] To Waterfall\
Left[C] Metal Cap Switch"))
...
Danger! Closed.\
Turn back now."))
smlua_text_utils_dialog_replace(DIALOG_126, 2, 3, 30, 200, ("Up[C] Black Hole\
Right[C] Work Elevator\
/// Hazy Maze"))
smlua_text_utils_dialog_replace(DIALOG_127, 3, 4, 30, 200, ("Underground Lake\
Right[C] Metal Cave\
Left[C] Abandoned Mine\
///|Closed>\
...
play fair!"))
smlua_text_utils_dialog_replace(DIALOG_133, 1, 6, 30, 200, ("Bienvenue au chateau de\
la princesse fala luigi\
bros de mario42gls42."))
smlua_text_utils_dialog_replace(DIALOG_134, 1, 5, 30, 200, ("Cher Luigi Bros de\
Mario42Gls42 je te\
souhaite la bienvenue\
dans l'ile aux couleurs\
vous marcher sur le \
drapeau de la france\
et celui de l'italie\
arrivera tu a recupe\
rer les 6 etoiles\
de ce niveau hein?\
bwabwahgwagwahhaha\
signee\
...
of the 15 courses!"))
smlua_text_utils_dialog_replace(DIALOG_138, 1, 3, 30, 200, ("Down[C] Underground Lake\
Left[C] Black Hole\
Right[C] Hazy Maze |Closed>"))
smlua_text_utils_dialog_replace(DIALOG_139, 1, 6, 30, 200, ("Above[C] Automatic Elevator\
Elevator begins\
...
///Elevator 1\
Arrow[C] You are here"))
smlua_text_utils_dialog_replace(DIALOG_141, 1, 5, 150, 200, ("Tu as eu 1 etoile tu peux\
desormais acceder au monde\
retro,au cercle retro ou a\
la maison de mamy toad."))
smlua_text_utils_dialog_replace(DIALOG_142, 1, 5, 150, 200, ("Tu as eu 3 etoile tu peux\
desormais acceder au mont\
cauchemardesque,la plaine\
bob-omb,le village crepus\
cule ou le groupes des \
vaisseaux."))
smlua_text_utils_dialog_replace(DIALOG_143, 1, 6, 150, 200, ("Tu as gagne 8 etoiles tu \
peux acceder a la maison de\
Zowser autrement dit l'ile\
attention boss."))
...
smlua_text_utils_dialog_replace(DIALOG_146, 1, 6, 150, 200, ("Bwabwahgwagwahhaha tu est \
tombe dans mon piege signee\
Zowser"))
...
automatically.\
//--The Snowman"))
smlua_text_utils_dialog_replace(DIALOG_149, 1, 3, 30, 200, ("Luigi Bros de\
Mario42Gls42 fait atten\
tion les virus informat\
iques se sont penetrer\
dans le systeme de l'\
ordinateur portable\
tu dois les vaincres\
et tu trouveras une\
etoile."))
