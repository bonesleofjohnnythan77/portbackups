...
static const Lights1 tm8house_seg7_lights_0700DE30 = gdSPDefLights1(
    0x33, 0x33, 0x33,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0700DE48 - 0x0700DF38
static const Vtx tm8house_seg7_vertex_0700DE48[] = {
...
static const Vtx tm8house_seg7_vertex_0700DF38[] = {
...
static const Vtx tm8house_seg7_vertex_0700E038[] = {
...
static const Vtx tm8house_seg7_vertex_0700E128[] = {
    {{{   240,   2683,  -5544}, 0, {  3748,   2264}, {0x31, 0x71, 0xe4, 0xff}}},
    {{{   801,   2683,  -5393}, 0, {  2658,   1170}, {0xa0, 0x34, 0xc0, 0xff}}},
...
static const Gfx tm8house_seg7_dl_0700E1E8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, generic_09009000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&tm8house_seg7_lights_0700DE30.l, 1),
    gsSPLight(&tm8house_seg7_lights_0700DE30.a, 2),
    gsSPVertex(tm8house_seg7_vertex_0700DE48, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  6,  4, 0x0,  5,  4,  7, 0x0),
    gsSP2Triangles( 5,  7,  8, 0x0,  8,  7,  9, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0, 11, 12, 13, 0x0),
    gsSP1Triangle(11, 13, 14, 0x0),
    gsSPVertex(tm8house_seg7_vertex_0700DF38, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  5,  6, 0x0,  3,  7,  4, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 11,  9, 0x0),
    gsSP2Triangles( 0,  2, 12, 0x0, 13, 14, 15, 0x0),
    gsSPVertex(tm8house_seg7_vertex_0700E038, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 3,  2,  4, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 5,  4,  6, 0x0,  5,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 11,  9, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(tm8house_seg7_vertex_0700E128, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx tm8house_seg7_dl_0700E338[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(tm8house_seg7_dl_0700E1E8),
