...
static const Lights1 tm8house_seg7_lights_0700E510 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0700E528 - 0x0700E628
static const Vtx tm8house_seg7_vertex_0700E528[] = {
...
static const Vtx tm8house_seg7_vertex_0700E628[] = {
    {{{  -180,      0,   -904}, 0, {   950,    284}, {0xac, 0xac, 0xd6, 0xff}}},
...
static const Gfx tm8house_seg7_dl_0700E6C8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, generic_09006000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&tm8house_seg7_lights_0700E510.l, 1),
    gsSPLight(&tm8house_seg7_lights_0700E510.a, 2),
    gsSPVertex(tm8house_seg7_vertex_0700E528, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  3,  5, 0x0,  7,  0,  2, 0x0),
    gsSP2Triangles( 8,  7,  2, 0x0,  9, 10, 11, 0x0),
    gsSP2Triangles(12,  9, 11, 0x0, 13, 14, 15, 0x0),
    gsSPVertex(tm8house_seg7_vertex_0700E628, 10, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx tm8house_seg7_dl_0700E768[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(tm8house_seg7_dl_0700E6C8),
