...
static const Vtx tm8house_seg7_vertex_0700E3E0[] = {
...
static const Gfx tm8house_seg7_dl_0700E420[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, generic_09008800),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(tm8house_seg7_vertex_0700E3E0, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
    gsSPEndDisplayList(),
};

// 0x0700E458 - 0x0700E510
const Gfx tm8house_seg7_dl_0700E458[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(tm8house_seg7_dl_0700E420),
