...
static const Vtx tm8house_seg7_vertex_0700E810[] = {
...
static const Gfx tm8house_seg7_dl_0700E860[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, generic_09008800),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(tm8house_seg7_vertex_0700E810, 5, 0),
...
const Gfx tm8house_seg7_dl_0700E8A0[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(tm8house_seg7_dl_0700E860),
