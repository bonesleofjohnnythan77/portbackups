smlua_text_utils_dialog_replace(DIALOG_000,1,6,30,200, ("Well Mario, it looks \
like you've returned to\
the old days of smashing\
goombas and sticking your\
face in sewage. Good to \
be home!"))

smlua_text_utils_dialog_replace(DIALOG_001,1,4,95,200, ("How did that... THING...\
Get in here?! As if this\
town isn't mysterious\
enough..."))
...
smlua_text_utils_dialog_replace(DIALOG_003,1,5,95,200, ("I got tired of no \
furniture around, so I\
bought a table to go up\
here. It looks bigger \
than it did online..."))

smlua_text_utils_dialog_replace(DIALOG_004,1,3,95,200, ("This house seems a \
little plain, don't you\
...
smlua_text_utils_dialog_replace(DIALOG_008,1,4,30,200, ("Hey, it's the masked \
bandit here. You may\
have seen me in Paper\
Mario. Anyway, I came\
here to grab some of\
this town's mysterious\
treasure, but I heard \
they keep most of it up\
high... Too bad I can't \
jump well..."))
...
smlua_text_utils_dialog_replace(DIALOG_015,1,4,30,200, ("Wow! You're smack in the\
middle of the battlefield!\
Just kidding... But good\
job, you found an easter\
egg. Now go show it off \
to youtube or something,\
you little cheater."))

smlua_text_utils_dialog_replace(DIALOG_016,1,3,30,200, ("Follow this path through\
...
smlua_text_utils_dialog_replace(DIALOG_018,1,4,30,200, ("Welcome, Mario! The NES\
is calling to you! Go\
ahead and play these two\
levels that have the \
great, original SMB theme"))
