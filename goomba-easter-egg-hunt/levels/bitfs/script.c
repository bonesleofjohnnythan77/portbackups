...
OBJECT_WITH_ACTS(22,0,119,2039,0,180,0,0xa0000, bhvWarpPipe
,31),
OBJECT_WITH_ACTS(0,583,2683,-5387,0,-154,0,0xb0000, bhvPenguinRaceFinishLine
,31),
OBJECT_WITH_ACTS(22,0,540,-9000,0,0,0,0xa0000, bhvWarpPipe
,31),
OBJECT_WITH_ACTS(121,0,717,-8357,0,107,0,0x0, bhvStar
,31),
OBJECT_WITH_ACTS(181,0,150,-2900,0,0,0,0x0, bhvBetaTrampolineTop
,31),
OBJECT_WITH_ACTS(240,0,0,-3250,0,0,0,0x0, bhvFlipBlock_MOP,31),
OBJECT_WITH_ACTS(240,0,256,-3250,0,0,0,0x0, bhvFlipBlock_MOP,31),
OBJECT_WITH_ACTS(240,0,512,-3250,0,0,0,0x0, bhvFlipBlock_MOP,31),
OBJECT_WITH_ACTS(242,0,0,-3250,0,0,0,0x0, bhvSwitchblock_Switch_MOP,31),
OBJECT_WITH_ACTS(241,0,690,-5700,0,0,0,0x20000, bhvSwitchblock_MOP,31),
OBJECT_WITH_ACTS(123,0,59,-3493,0,0,0,0x200000, bhvNoteblock_MOP,31),
OBJECT_WITH_ACTS(194,0,0,619,0,0,0,0x0, bhvCirclingAmp
,31),
OBJECT_WITH_ACTS(242,0,0,-700,0,0,0,0x10000, bhvSwitchblock_Switch_MOP,31),
OBJECT_WITH_ACTS(217,0,0,-700,0,0,0,0x0, bhvPushableMetalBox
,31),
OBJECT_WITH_ACTS(241,0,152,-2046,0,0,0,0x0, bhvSwitchblock_MOP,31),
OBJECT_WITH_ACTS(241,9,185,-1188,0,0,0,0x20000, bhvSwitchblock_MOP,31),
OBJECT_WITH_ACTS(146,0,403,-300,-20,180,0,0x0, bhvSpring_MOP,31),
OBJECT_WITH_ACTS(241,0,0,-300,0,0,0,0x0, bhvSwitchblock_MOP,31),
OBJECT_WITH_ACTS(242,0,0,800,0,0,0,0x0, bhvSwitchblock_Switch_MOP,31),
OBJECT_WITH_ACTS(241,0,0,300,0,0,0,0x20000, bhvSwitchblock_MOP,31),
OBJECT_WITH_ACTS(241,0,0,-300,0,0,0,0x20000, bhvSwitchblock_MOP,31),
RETURN()
};
const LevelScript local_warps_bitfs_1_[] = {
WARP_NODE(10,16,1,11,0),
