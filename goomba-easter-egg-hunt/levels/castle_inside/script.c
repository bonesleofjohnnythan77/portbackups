...
// LOAD_MODEL_FROM_DL(23,0x0e0329d0,4),
// LOAD_MODEL_FROM_DL(24,0x0e0369d0,4),
// LOAD_MODEL_FROM_DL(25,0x0e03a9d0,4),
// LOAD_MODEL_FROM_DL(27,0x0e03e9d0,4),
...
TERRAIN(col_castle_inside_1_0xe017f28),
...
OBJECT_WITH_ACTS(0,485,122,-738,0,0,0,0xa0000, bhvSpinAirborneWarp
,31),
OBJECT_WITH_ACTS(0,490,122,-1413,0,-154,0,0x200b0000, bhvWarp
,31),
OBJECT_WITH_ACTS(23,1158,484,1038,0,-153,0,0xc0000, id_bhvStripeBall
,31),
OBJECT_WITH_ACTS(24,-192,583,1045,0,107,0,0xd0000, id_bhvBowloGloverBall
,31),
OBJECT_WITH_ACTS(25,1145,517,140,0,-151,0,0xe0000, id_bhvGreyBall
,31),
OBJECT_WITH_ACTS(27,-333,424,562,0,0,0,0x0, id_bhvBeachBall
,31),
OBJECT_WITH_ACTS(0,2541,122,1436,0,0,0,0x30010000, bhvWarp
,31),
OBJECT_WITH_ACTS(0,489,122,2498,0,0,0,0x30020000, bhvWarp
,31),
OBJECT_WITH_ACTS(0,1646,122,2288,0,0,0,0x300c0000, bhvWarp
,31),
RETURN()
};
