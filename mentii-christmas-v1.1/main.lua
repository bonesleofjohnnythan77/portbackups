-- name: Mentii Christmas v1.1
-- description: A Christmas 2025 Kaizo Hack made by Memphis, showcasing six levels coming out of his creative mind. Five of them are dedicated to some of his closest friends.\n\nKaizo Difficulty: 3.0\n\n This hack has 14 stars total. \n\nPorted by B. Bones Johnson
...
vec3f_set(gLevelValues.starPositions.ChillBullyStarPos, 845.0, 3738.0, 9222.0)
...
vec3f_set(gLevelValues.starPositions.MrIStarPos, 4193.0, 2160.0, -3398.0)
...
hook_event(HOOK_ON_HUD_RENDER, function() hud_set_value(HUD_DISPLAY_FLAGS, hud_get_value(HUD_DISPLAY_FLAGS) & ~HUD_DISPLAY_FLAG_LIVES) end)
