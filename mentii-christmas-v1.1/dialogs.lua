smlua_text_utils_dialog_replace(DIALOG_000,1,6,30,200, ("Ho ho ho! It's that time\
of the year it seems...\
There are five paintings\
you can choose from.\
Four of them are profile\
pictures of people who\
supported me this year.\
(from left to right:\
Lanayxy,\
spiderbitesarelovebites,\
me, clairychan57,\
skullkid)\
This hack has 14 stars\
in total and there is\
one level that is only\
accessible within another\
stage. You can find it in\
the stage in the painting\
on the left of mine!\
...
smlua_text_utils_dialog_replace(DIALOG_008,1,4,30,200, ("Dedicated to lovebites,\
inspired by Celeste 64"))
...
smlua_text_utils_dialog_replace(DIALOG_053,1,4,30,200, ("『Do I really have to do\
crudelo reds?』\
Jump off the stage real\
quick, trust me..."))
