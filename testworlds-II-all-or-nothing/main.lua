-- name: SM64 Test Worlds II - All or Nothing Demo
-- description: Another test hack by Apioeus, made for SirRouven1003's Level Pack.\nThis hack was meant to have 15-18 stars but was not finished, so it only has one star.\nThe hack is much more difficult than the original Test Worlds.\nAdditionally, the level has a timer that counts down.\n\nPorted by BlackJoystick\n\nSpecial Thanks to Fearl for programming assistance.
...
smlua_audio_utils_replace_sequence(0x03, 0x0E, 75, "03_Seq_custom")
smlua_audio_utils_replace_sequence(0x06, 0x25, 75, "06_Seq_custom")
smlua_audio_utils_replace_sequence(0x09, 0x19, 75, "09_Seq_custom")
...
smlua_audio_utils_replace_sequence(0x23, 0x19, 75, "23_Seq_custom")
...
vec3f_set(gLevelValues.starPositions.PssSlideStarPos, 319.0, -5320.0, 388.0)
