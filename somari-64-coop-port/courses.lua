smlua_text_utils_course_acts_replace(COURSE_BOB, (" 1 NEW NIMBUS CITY"),	("REACH THE GOAL"),	("THE KING OF SPEED!"),	("8 HIDDEN CURRENCIES"),	("END OF THE LINE"),	("HARDCORE PARKOUR!!!"),	("YOU DID IT! ONLY 5 STARS IN THIS LEVEL!"))
