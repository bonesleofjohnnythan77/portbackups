smlua_text_utils_dialog_replace(DIALOG_000,2,4,95,200, ("So here a few thing you\
should know before\
playing...\
\
You can run fast!..\
...
This game highly\
recommend using a\
controller with dual\
thumbsticks.\
by using the left stick\
for movement and the\
right stick for moving\
the camera.\
You can now hold the\
direction of the right\
stick for moving the\
camera more precisely!\
which can also help for\
steering Mari... uh...\
Somari during high\
speeds!\
...
smlua_text_utils_dialog_replace(DIALOG_001,1,4,95,200, ("   ★Koopa The Quick★\
\
   ★Time Challenge★"))
...
smlua_text_utils_dialog_replace(DIALOG_008,1,4,30,200, ("Did you know?\
\
\
\
The default running\
...
\
\
but to think somewhere\
out there is a strange\
blue rodent who can run\
...
smlua_text_utils_dialog_replace(DIALOG_013,1,5,30,200, ("Did you smell that?\
\
That was the smell of\
      VICTORY!!!\
//Hell Yeah!////meh..."))

smlua_text_utils_dialog_replace(DIALOG_014,1,4,30,200, ("Did you smell that?\
\
That was the smell of...\
\
       VICTORY!!!\
...
smlua_text_utils_dialog_replace(DIALOG_015,1,1,30,200, ("come on run away\
you don't have to stay\
we nearly outta time\
but your doin' fine\
so stay on track\
and don't look back\
just feel the pace\
...
smlua_text_utils_dialog_replace(DIALOG_016,1,4,30,200, ("Did you know?\
\
\
\
There has been many\
recent ghost sightings\
within New Nimbus City?\
\
The first ghost sightings\
originated from a\
mysterious location call...\
\
Shiverburn Gal... la...\
gallery?..\
Shiverburn Gallery?..\
I think?... anyway\
Some people mention of \
two shadowy figures\
standing still...\
\
menacingly...\
...
smlua_text_utils_dialog_replace(DIALOG_017,1,4,30,200, ("a"))

smlua_text_utils_dialog_replace(DIALOG_018,1,4,30,200, ("Thank you for playing\
Somari 64: DASH!\
mini hack created by\
DobieMeltfire\
\
       ★Credits★\
\
...
smlua_text_utils_dialog_replace(DIALOG_019,1,3,30,200, ("You can change the\
BGM by stepping on\
these music notes!\
Blue-\
Sonic R\
...
smlua_text_utils_dialog_replace(DIALOG_033,1,6,30,200, ("Ciao!"))
...
smlua_text_utils_dialog_replace(DIALOG_035,1,4,30,200, ("        Warning!\
This song may make\
you cry like a anime\
fan on prom night!"))

smlua_text_utils_dialog_replace(DIALOG_036,2,4,30,200, ("So...uh... in case you\
didn't read the first\
signpost\
\
You can increase your\
running speed by\
performing triple jumps\
\
but be careful of\
running too fast!\
\
\
You may run against\
the slippery sideroad...\
or worse...\
falling off course...\
So you may have to slow\
down before sharp\
corners or dangerous\
sections.\
One last thing!..\
\
\
\
Do you see that strange\
colorful thingamajig\
on the ground?\
\
...
smlua_text_utils_dialog_replace(DIALOG_039,1,4,30,200, ("Those skyscraper look\
kinda cool right?\
\
\
I mean did you ever wish\
...
I have even heard\
rumors of a shiny\
treasure hid on top on\
one of these buildings!\
Well...kinda an odd\
place to hid something\
don't you think so?\
\
By the way...\
\
...
believe me.\
\
also try running at it\
at high speed and\
watch it spin like a\
blender!"))

smlua_text_utils_dialog_replace(DIALOG_040,1,3,30,200, ("Yeah way back when\
Blockbuster was still a\
thing... this song played."))
...
smlua_text_utils_dialog_replace(DIALOG_084,1,4,30,200, ("WHOA! Whoa!\
Personal space!\
ever heard it?\
\
what? who am I?\
...
mini hack?\
\
Did you find it too hard?\
too easy perhaps?\
\
\
at least the 8 red coins\
or King of Speed star\
has given you a run for\
your money!...ay?\
