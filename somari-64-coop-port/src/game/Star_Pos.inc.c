#define KoopaBoBStarPos { -7819, 463, 26022 }
...
#define BigBullyStarPos 0.0f, 950.0f, -6800.0f
...
#define PssSlideStarPos -7819.0f, 463.0f, 26022.0f
...
#define MrIStarPos 1370.0f, 2000.0f, -320.0f
