...
#define HUD_LIVES_MARIO_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(0)
#define HUD_LIVES_MARIO_Y 80
#define HUD_LIVES_CROSS_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(100)
#define HUD_LIVES_CROSS_Y 80
#define HUD_LIVES_NUM_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(30)
#define HUD_LIVES_NUM_Y 80
#define HUD_COINS_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(0)
#define HUD_COINS_Y 60
#define HUD_COINS_CROSS_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(100)
#define HUD_COINS_CROSS_Y 60
#define HUD_COINS_NUM_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(30)
#define HUD_COINS_NUM_Y 60
#define HUD_STARS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(320)
#define HUD_STARS_Y 40
#define HUD_STARS_CROSS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(220)
#define HUD_STARS_CROSS_Y 40
#define HUD_STARS_NUM_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(304)
#define HUD_STARS_NUM_Y 40
...
#define POWER_Y 166
#define SHOW_STARS 0
#define SHOW_COINS 50
#define SHOW_LIVES 176
#define SHOW_CAM 11
#define SHOW_TIME 11
