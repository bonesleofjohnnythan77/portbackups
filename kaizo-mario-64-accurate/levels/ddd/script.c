...
MACRO_OBJECT_WITH_BEH_PARAM(macro_seaweed_bundle,0,62656,62416,63686,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,60536,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_seaweed_bundle,0,62026,62416,1950,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,60736,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,60936,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_ring_vertical,90,64536,61286,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,61136,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,61336,0,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,61536,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,61736,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,61936,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_sushi,0,62536,62136,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_koopa_shell_underwater,0,64033,60409,64366,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_vanish_cap,0,6800,500,65453,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_floor_switch_hidden_objects,0,6800,110,500,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,1414,1020,772,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,1414,1020,1072,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,1814,1020,1072,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,1814,1020,772,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,1614,1020,622,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,1614,1020,1222,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_water_bomb_cannon_copy,0,3775,55536,63836,1),
MACRO_OBJECT_WITH_BEH_PARAM(macro_water_bomb_cannon_copy,0,4025,56790,64059,1),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bobomb_still,90,3810,55536,1350,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_bobomb_still,90,4040,55536,850,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,938,10000,4107,0),
...
,62),
OBJECT_WITH_ACTS(122,-3000,850,3200,0,0,0,0x1000000, bhvStar
,63),
OBJECT_WITH_ACTS(87,-3174,-4915,102,0,0,0,0x0, bhvWhirlpool
,31),
OBJECT_WITH_ACTS(217,-3000,-150,-3200,0,90,0,0x0, bhvPushableMetalBox
,31),
OBJECT_WITH_ACTS(207,-3000,157,-3200,0,0,0,0x0, bhvFloorSwitchHiddenObjects
,31),
OBJECT_WITH_ACTS(129,-3000,100,3200,0,0,0,0x0, bhvHiddenObject
,31),
OBJECT_WITH_ACTS(86,-3000,-2800,0,0,0,0,0x0, bhvSushiShark
,31),
OBJECT_WITH_ACTS(86,-3000,-3000,0,0,0,0,0x0, bhvSushiShark
,31),
OBJECT_WITH_ACTS(86,-3000,-3200,0,0,0,0,0x0, bhvSushiShark
,31),
OBJECT_WITH_ACTS(0,-3071,500,0,0,7,0,0xa0000, bhvSpinAirborneWarp
,31),
