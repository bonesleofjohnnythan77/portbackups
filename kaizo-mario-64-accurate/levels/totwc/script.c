...
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_wing_cap,0,0,2400,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_star_1,0,0,3000,0,8),
MACRO_OBJECT_END(),
};
...
OBJECT_WITH_ACTS(85,0,-2047,10,0,0,0,0x0, bhvCapSwitch
,31),
OBJECT_WITH_ACTS(0,800,-1700,0,0,0,0,0x1000000, bhvHiddenRedCoinStar
,31),
OBJECT_WITH_ACTS(0,-4095,2935,0,0,90,0,0xa0000, bhvFlyingWarp
,31),
