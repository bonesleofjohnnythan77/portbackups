...
MACRO_OBJECT_WITH_BEH_PARAM(macro_floor_switch_hidden_objects,0,1230,63386,63789,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up,0,6735,3800,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,45,2030,63011,62936,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,90,2430,62786,62136,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_flamethrower,0,1600,62465,425,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,135,2030,62561,61336,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_pushable_metal_box,0,60936,62161,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,180,1230,62336,60936,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up,0,6735,3800,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_flamethrower,0,1000,62465,425,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_chuckya,270,2500,62772,562,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_flamethrower,0,1000,62465,700,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_flamethrower,0,1600,62465,700,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_fly_guy,0,59036,3789,64736,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up,0,6735,3800,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_fly_guy,180,60536,600,700,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,57936,62536,63536,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,58636,62536,62036,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_fly_guy,180,60536,600,65436,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_blue_coin_switch,0,57936,63036,58036,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,58636,62536,59036,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_blue_coin,0,57936,62536,60536,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_coin_line_horizontal_flying,90,63236,3600,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bouncing_fireball_copy,90,64936,900,300,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bouncing_fireball,90,64936,900,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bouncing_fireball,90,64936,900,500,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,2350,62791,562,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,2888,64136,310,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,1230,62636,60936,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,7600,63036,250,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,62301,3568,65116,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,4285,4000,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_box,0,7630,62811,250,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,64146,3575,65116,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,1225,5525,75,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_red_coin,0,63690,2000,65060,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_flamethrower,0,1229,225,300,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,0,3900,100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_fire_spitter,0,64956,62686,562,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_three_coins,0,63690,1700,65060,0),
MACRO_OBJECT_END(),
};
...
OBJECT_WITH_ACTS(0,-7500,-2500,0,0,0,0,0x0, bhvBowserCourseRedCoinStar
,31),
...
,31),
OBJECT_WITH_ACTS(0,-5300,-2700,800,0,180,0,0x0, bhvFlamethrower
,31),
OBJECT_WITH_ACTS(0,-5300,-2400,800,0,180,0,0x0, bhvFlamethrower
,31),
OBJECT_WITH_ACTS(0,-5300,-2700,-800,0,0,0,0x0, bhvFlamethrower
,31),
...
,31),
OBJECT_WITH_ACTS(0,-5300,-2400,-800,0,0,0,0x0, bhvFlamethrower
,31),
OBJECT_WITH_ACTS(212,6735,3800,100,0,0,0,0x0, bhv1Up
,31),
OBJECT_WITH_ACTS(212,6735,3800,100,0,0,0,0x0, bhv1Up
,31),
OBJECT_WITH_ACTS(212,6735,3800,100,0,0,0,0x0, bhv1Up
...
OBJECT_WITH_ACTS(212,6735,3800,100,0,0,0,0x0, bhv1Up
,31),
OBJECT_WITH_ACTS(56,-3225,3440,96,0,0,0,0x0, bhvBitfsSinkingPlatforms
,31),
OBJECT_WITH_ACTS(212,6735,3800,100,0,0,0,0x0, bhv1Up
,31),
OBJECT_WITH_ACTS(56,-1381,3440,96,0,0,0,0x0, bhvBitfsSinkingPlatforms
,31),
OBJECT_WITH_ACTS(212,6735,3800,100,0,0,0,0x0, bhv1Up
,31),
OBJECT_WITH_ACTS(212,6735,3800,100,0,0,0,0x0, bhv1Up
,31),
OBJECT_WITH_ACTS(217,1000,-3375,450,45,90,45,0x0, bhvPushableMetalBox
,31),
OBJECT_WITH_ACTS(0,-7500,-2000,0,0,90,0,0xc0000, bhvDeathWarp
,31),
OBJECT_WITH_ACTS(0,6735,3681,99,0,0,0,0x140b0000, bhvWarp
,31),
OBJECT_WITH_ACTS(0,-7600,-1764,-7500,0,0,0,0xa0000, bhvAirborneWarp
,31),
