...
const Collision bowser_3_seg7_collision_level[] = {
    ...
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/ -4000,  300,  1325, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/     0,  300,  4100, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/  4000,  300,  1300, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/  2650,  300, -3500, /*yaw*/    0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/ -2550,  300, -3450, /*yaw*/    0),
    COL_END(),
};
