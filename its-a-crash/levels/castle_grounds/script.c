...
TERRAIN(col_castle_grounds_1_0xe016c38),
...
OBJECT_WITH_ACTS(0,1796,-14,-1849,0,0,0,0xa0000, bhvSpinAirborneWarp
,31),
...
,31),
OBJECT_WITH_ACTS(0,1796,-1022,-1849,0,0,0,0xc0000, bhvSwimmingWarp
,31),
OBJECT_WITH_ACTS(22,-1440,-245,-3555,0,0,0,0x30000, bhvWarpPipe
,31),
OBJECT_WITH_ACTS(22,-3076,232,2213,0,0,0,0x0, bhvWarpPipe
,31),
OBJECT_WITH_ACTS(0,-1741,243,-3508,0,297,0,0x10000, bhvPaintingStarCollectWarp
,31),
OBJECT_WITH_ACTS(0,-1741,243,-3508,0,297,0,0x20000, bhvPaintingDeathWarp
,31),
OBJECT_WITH_ACTS(0,1919,-415,-2182,0,145,0,0xf00000, bhvPaintingStarCollectWarp
,31),
OBJECT_WITH_ACTS(0,1919,-415,-2182,0,145,0,0xf10000, bhvPaintingDeathWarp
,31),
OBJECT_WITH_ACTS(221,2572,-763,2952,0,172,0,0x85000000, bhvToadMessage
,31),
OBJECT_WITH_ACTS(221,1709,-1048,-1082,0,166,0,0x4d000000, bhvToadMessage
,31),
OBJECT_WITH_ACTS(0,1489,-1048,174,0,0,0,0x0, bhvGoombaTripletSpawner
,31),
OBJECT_WITH_ACTS(192,1102,-1048,1135,0,0,0,0x0, bhvGoomba
,31),
OBJECT_WITH_ACTS(192,1288,-1048,3531,0,0,0,0x0, bhvGoomba
,31),
OBJECT_WITH_ACTS(188,-2849,-240,-2764,0,0,0,0x0, bhvBobomb
,31),
OBJECT_WITH_ACTS(0,0,0,0,0,0,0,0x0, bhvAmbientSounds
,31),
OBJECT_WITH_ACTS(0,0,0,0,0,0,0,0x0, bhvBirdsSoundLoop
,31),
OBJECT_WITH_ACTS(0,-3200,1000,-1400,0,0,0,0x0, bhvAmbientSounds
,31),
OBJECT_WITH_ACTS(0,-3200,1000,-1400,0,0,0,0x0, bhvBirdsSoundLoop
,31),
OBJECT_WITH_ACTS(23,2592,-1048,-1481,0,0,0,0x0, bhvTree
,31),
OBJECT_WITH_ACTS(23,845,-1048,1479,0,0,0,0x0, bhvTree
,31),
OBJECT_WITH_ACTS(23,-2121,-240,-3856,0,0,0,0x0, bhvTree
,31),
OBJECT_WITH_ACTS(23,-3253,240,2907,0,0,0,0x0, bhvTree
,31),
OBJECT_WITH_ACTS(188,-1267,-240,-3016,0,0,0,0x0, bhvBobomb
,31),
OBJECT_WITH_ACTS(0,2592,-441,-1481,0,0,0,0x0, bhvHidden1upInPoleSpawner
,31),
OBJECT_WITH_ACTS(0,1816,-998,3389,0,164,0,0x220000, bhvSignOnWall
,31),
OBJECT_WITH_ACTS(0,-3402,-193,-2199,0,39,0,0x210000, bhvSignOnWall
,31),
OBJECT_WITH_ACTS(0,-3585,-193,-1927,0,79,0,0xa70000, bhvSignOnWall
,31),
OBJECT_WITH_ACTS(124,1451,-1048,-2333,0,27,0,0xa90000, bhvMessagePanel
,31),
RETURN()
};
...
WARP_NODE(1,9,1,240,0),
WARP_NODE(2,9,1,241,0),
