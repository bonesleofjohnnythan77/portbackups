...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,63185,673,890,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up,0,60436,540,61466,4),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,60136,216,61466,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,60736,216,61466,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,60436,216,61766,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,60436,216,61166,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,90,6387,675,58964,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,7696,50,6029,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,61689,50,61006,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,11629,50,64836,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,11629,50,308,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,7531,44,4722,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,7316,44,3445,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,7229,200,2615,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_1up,0,0,307,63451,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,90,58826,258,4726,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,58768,320,58737,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,62388,320,63462,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_star_trigger,0,59610,246,6901,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,4170,154,63596,0),
...
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_ten_coins,0,59636,460,6400,0),
MACRO_OBJECT_END(),
};
static const MacroObject local_macro_objects_lll_2[] = {
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,65516,82,64136,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,600,82,64056,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,1080,82,63856,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,2180,173,63676,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,2520,174,64316,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,2840,249,65076,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,2800,449,460,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,1300,1029,2300,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,64576,2442,62926,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,2180,775,1720,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,1700,1029,2100,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,940,1029,2540,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,64156,102,1640,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,63493,1678,1500,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,63253,1863,800,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,63116,1981,280,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,62916,2089,65256,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,62996,2268,64596,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,1330,3201,1313,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,1069,3130,1243,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bully,0,704,3028,1156,0),
...
OBJECT_WITH_ACTS(122,3100,400,7900,0,0,0,0x3000000, bhvStar
,63),
OBJECT_WITH_ACTS(0,-4362,350,528,0,0,0,0x2000000, bhvHiddenRedCoinStar
,63),
OBJECT_WITH_ACTS(0,1050,550,6200,0,0,0,0x4000000, bhvHiddenStar
,48),
OBJECT_WITH_ACTS(223,4935,310,-645,0,90,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,7500,307,1335,0,315,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,6414,379,7209,0,315,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-2300,619,815,0,0,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-5533,149,6895,0,90,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,4294,311,-5673,0,90,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-14,154,4626,0,270,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(0,0,200,-2048,0,0,0,0x0, bhvFlamethrower
,31),
OBJECT_WITH_ACTS(86,-5130,285,-1663,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,7168,307,998,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,6813,307,1613,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,0,307,3712,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,-5119,307,-2482,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(87,4046,2234,-5521,0,0,0,0x1000000, bhvBigBullyWithMinions
,31),
OBJECT_WITH_ACTS(87,0,307,-4385,0,0,0,0x0, bhvBigBully
,31),
OBJECT_WITH_ACTS(0,-5843,211,6681,0,0,0,0x0, bhvMrI
,31),
OBJECT_WITH_ACTS(180,3139,469,-5820,0,0,0,0x0, bhvFireSpitter
,31),
OBJECT_WITH_ACTS(180,4200,448,-5361,0,0,0,0x0, bhvFireSpitter
,31),
OBJECT_WITH_ACTS(180,508,463,-4338,0,90,0,0x0, bhvFireSpitter
,31),
OBJECT_WITH_ACTS(55,5293,0,6124,0,0,0,0x0, bhvLllSinkingRockBlock
,31),
OBJECT_WITH_ACTS(180,6,1081,-6807,0,0,0,0x0, bhvFireSpitter
,31),
OBJECT_WITH_ACTS(180,-479,417,-4727,0,0,0,0x0, bhvFireSpitter
,31),
OBJECT_WITH_ACTS(86,-455,307,-4227,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,3978,307,-5688,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,-3225,154,6253,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,2943,256,7766,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,449,307,-3949,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(86,3519,307,-5260,0,0,0,0x0, bhvSmallBully
,31),
OBJECT_WITH_ACTS(223,3341,563,4930,0,90,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-1136,154,6264,0,90,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-6816,105,4313,0,0,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-60,768,-6494,0,90,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(220,-1848,729,351,0,0,0,0x0, bhvFlyGuy
,31),
OBJECT_WITH_ACTS(58,-5119,307,-4095,0,0,0,0x0, bhvLllRotatingBlockWithFireBars
,31),
OBJECT_WITH_ACTS(56,-1919,307,3648,0,0,271,0x0, bhvLllDrawbridgeSpawner
,31),
OBJECT_WITH_ACTS(14,-5115,300,-3200,0,90,0,0x0, bhvLllHexagonalMesh
,31),
OBJECT_WITH_ACTS(13,0,0,-2047,0,0,0,0x0, bhvStaticObject
,31),
OBJECT_WITH_ACTS(223,-4357,208,312,0,0,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-2643,156,6198,0,270,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,-5082,307,-2071,0,180,0,0x0, bhvChuckya
,31),
OBJECT_WITH_ACTS(223,7255,365,1532,0,270,0,0x0, bhvChuckya
,31),
...
,31),
OBJECT_WITH_ACTS(129,-3199,417,3456,0,0,0,0x0, bhvBreakableBox
,31),
OBJECT_WITH_ACTS(120,43,206,5313,0,0,0,0x0, bhvRecoveryHeart
,31),
OBJECT_WITH_ACTS(5,7168,0,1408,0,0,0,0x0, bhvStaticObject
,31),
OBJECT_WITH_ACTS(217,4992,0,-639,0,0,0,0x0, bhvPushableMetalBox
,31),
OBJECT_WITH_ACTS(0,3840,260,-5631,0,0,0,0x0, bhvBouncingFireball
,31),
OBJECT_WITH_ACTS(0,-5888,154,6656,0,100,0,0xd0000, bhvFadingWarp
,31),
OBJECT_WITH_ACTS(0,-3200,11,3456,0,-100,0,0xc0000, bhvFadingWarp
,31),
OBJECT_WITH_ACTS(0,0,105,0,0,0,0,0x190b0000, bhvWarp
,31),
OBJECT_WITH_ACTS(0,-3836,1154,7315,0,90,0,0xa0000, bhvSpinAirborneWarp
,31),
...
OBJECT_WITH_ACTS(122,1800,3400,1450,0,0,0,0x5000000, bhvStar
,63),
OBJECT_WITH_ACTS(206,2523,3850,-901,0,0,0,0x0, bhvSnufit
,63),
OBJECT_WITH_ACTS(0,-26,103,-2649,0,0,0,0x0, bhvVolcanoSoundLoop
,31),
OBJECT_WITH_ACTS(180,184,980,-1366,0,180,0,0x0, bhvFireSpitter
,31),
OBJECT_WITH_ACTS(180,-764,0,1664,0,180,0,0x0, bhvFireSpitter
,31),
...
,31),
OBJECT_WITH_ACTS(0,783,1126,-47,0,0,0,0x40000, bhvFlamethrower
,31),
OBJECT_WITH_ACTS(206,1413,3378,-2190,0,0,0,0x0, bhvSnufit
,31),
OBJECT_WITH_ACTS(0,1078,3078,-2269,0,0,0,0x40000, bhvFlamethrower
,31),
OBJECT_WITH_ACTS(206,1043,3128,-2679,0,0,0,0x0, bhvSnufit
,31),
OBJECT_WITH_ACTS(206,728,2762,-2754,0,0,0,0x0, bhvSnufit
,31),
