smlua_text_utils_dialog_replace(DIALOG_000,1,6,30,200, ("HAHAHAHAHA!\
Chain Chomps und\
Chuckyas gefaellig?\
\
Ja hier kriegste\
...
smlua_text_utils_dialog_replace(DIALOG_001,1,4,95,200, ("Buu Huus Kurs ist Weg!"))

smlua_text_utils_dialog_replace(DIALOG_002,1,4,95,200, ("Du willst wissen wie du\
auf die Insel kommst?\
Ganz einfach mach ein \
Weitsprung zur dieser\
Ecke davorne und spring\
nochmal mit ein Weitsprung\
ab"))

smlua_text_utils_dialog_replace(DIALOG_003,1,5,95,200, ("HAHA leider gibt es\
keine Kanonen mehr.\
Du musst ohne auskommen!"))
...
smlua_text_utils_dialog_replace(DIALOG_005,1,3,30,200, ("Haha Mario du hast\
