-- name: Super Trash 64 
-- description: A hack that truly is the definition of Trash, made for the SirRouven1003 Level Pack. \n\nCreated by: Chrizzy Gehle, Kaze, Pidi64 and UED \n\nPorted by: B. Bones Johnson, Fearl\n\nNOTE: This hack is only available in German.
...
vec3f_set(gLevelValues.starPositions.KoopaBobStarPos, 756, -469, 2819)
vec3f_set(gLevelValues.starPositions.KoopaThiStarPos, 7100, -1300, -6000)
vec3f_set(gLevelValues.starPositions.KingBobombStarPos, -3266.0, -1381.0, -1725.0)
